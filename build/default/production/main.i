...
void sendByte(unsigned char b) {
    if (b & 0b10000000) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b01000000) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00100000) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00010000) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00001000) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00000100) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00000010) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00000001) { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; } else { LATCbits.LATC4 = 1; __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop(); LATCbits.LATC4 = 0; __nop(); __nop(); __nop(); __nop();; }
}
